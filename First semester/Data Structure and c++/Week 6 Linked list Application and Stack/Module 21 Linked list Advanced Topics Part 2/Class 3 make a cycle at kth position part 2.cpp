...
int main()
{
    ...
    cout<<"Choice 1: Insertion at Head" <<endl
        ...
        <<"Choice 15: Create Cycle K-th Position " <<endl
        <<"Choice 16: Detect Cycle in the list." <<endl
        <<"Choice 17: Remove Cycle in the list(If Any)." <<endl
    ...
    while(n!=0)
    {
        ...
        case 14:
            int mid;
            mid = findMid(head);
            if(mid==0) cout<<"The LL is empty" <<endl;
            else
        ...
        case 17:
            ...
            {
                removeCycle(head);
                cout<<"Cycle Remove successfull"<<endl;
            }
            else
            {
                cout<<"There is No Cycle in the list." <<endl;
