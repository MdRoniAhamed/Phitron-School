...
class Window(QWidget):
    ...
    def __init__(self):
        ...
        # setup the window
        self.setWindowTitle("My First camera.")
...
if __name__ == '__main__':
    ...
    rec_icon_path = "E:\CSE Education\Phitron-School\Project\Camera\assets\video-camera.png"
